...
const bookOrigins = [
  ...
  { value: "replica", label: "Replica Copy" },
  { value: "first-edition", label: "First Edition" },
  { value: "reprint", label: "Reprint Edition" },
  { value: "pirated", label: "Pirated Copy" },
  { value: "translated", label: "Translated Version" },
  { value: "abridged", label: "Abridged Edition" },
  { value: "unabridged", label: "Unabridged Edition" },
  { value: "annotated", label: "Annotated Edition" },
...
export { yesOrNo, writersNationality, bookConditions, bookGenres, bookOrigins,readingStatus };
